...
export class InstalasiPage {
    ...
    async verifyPageLoaded() {
        ...
        await expect(this.page.getByRole('navigation', { name: 'breadcrumb' })
            .getByText('Daftar Instalasi')).toBeVisible();
        await expect(this.page.getByRole('button', { name: 'Cari Alokasi' })).toBeVisible();
    ...
    async changePageSizeTo25() {
        ...
        await this.page.getByRole('combobox', { name: /Baris per halaman:/ }).click();
